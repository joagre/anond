...
LIBS=common ds jsx node procket salt test tunctl util
...
debug:
	$(ERL) -pa lib/common/ebin -pa lib/ds/ebin -pa lib/jsx/ebin -pa lib/node/ebin -pa lib/procket/ebin -pa lib/salt/ebin -pa lib/test/ebin -pa lib/tunctl/ebin -pa lib/util/ebin
