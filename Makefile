...
LIBS=common ds jsx node overseer procket socks tunctl util
...
debug:
	$(ERL) -pa lib/common/ebin -pa lib/ds/ebin -pa lib/jsx/ebin -pa lib/node/ebin -pa lib/overseer/ebin -pa lib/procket/ebin lib/socks/ebin -pa lib/tunctl/ebin -pa lib/util/ebin
