  ...
  var networkTopologyHandler = function(networkTopology) {
    ...
    for (var i = 0; i < networkTopology.length; i++)
      for (var j = 0; j < networkTopology[i]["route-entries"].length; j++) {
        ...
        for (var k = 0; k < networkTopology[i]["route-entries"][j].length;
             k++) {
          ...
          var fromPathCost = self._lookupPathCost(from, to, networkTopology);
          var toPathCost = self._lookupPathCost(to, from, networkTopology);
          var pathCost = null;
